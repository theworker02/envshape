...
envshape is proprietary Product IP associated with `theworker02/envshape`. Acquisition value is the working materials, documentation, and a clear path to either a commercial license or an asset purchase â€” not an open-source community project.
